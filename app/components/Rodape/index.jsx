			...
			<div className="container">
				<div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-2 gap-10  sm:gap-10">
					...
					<ul className="text-xl sm:text-4xl font-bold flex flex-col gap-4 sm:gap-7 pb-9">
						<li><a href="mailto:romariojs94@gmx.com" title="Email">romariojs94@gmx.com</a></li>
						<li><a title="WhatsApp" target="_blank" rel="noopener noreferrer" href="https://api.whatsapp.com/send?phone=5547996497702&text=Ol%C3%A1,%20quero%20saber%20mais%20sobre%20os%20seus%20servi%C3%A7os.
